...
const registerUser = asyncHandler( async (req,res) =>{
    ...
    const coverImage = await uploadOnCloudinary(coverImageLocalPath) ? await uploadOnCloudinary(coverImageLocalPath) : null
...
export {registerUser,loginUser,logoutUser,refreshAccessToken,changeCurrentPassword,getCurrentUser,updateAccountDetails,userUpdateAvatar,getUserChannelProfile,getWatchHistory} 